...
class DocumentProcessingError(SUJBOT2Error):
    """
    General document processing error.

    Raised when document processing fails for reasons other than
    file not found or parsing errors. This is a catch-all for
